export default {
  ...
  methods: {
    ...
    changeHeader(section) {
      ...
      if (section === 'error' || section === 'contact-us' || section === 'services' || section === 'secret' || section === 'containerForm' || section === 'challenge-us' || section === 'projects' || section === 'activity' || section === 'love' || section === 'ourTeam' || section === 'ourResponse' || section === 'levelThree' || section === 'mac' || section === 'clients' || section === 'content') {
        tl
          .call(() => {

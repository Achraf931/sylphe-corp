<template>
  <section :id="gsapTarget" class="z-10 relative w-full overflow-hidden max-w-screen min-h-screen flex items-center" :class="{'flex-col': this.$mq === 'sm', 'justify-between': this.bottomImage !== '' && this.topImage !== '', 'justify-center': this.bottomImage === '' && this.topImage === '', 'justify-end': this.topImage === '' && this.bottomImage !== '' }" >
    <img v-if="!!this.leftImage && this.$mq === 'lg'" :class="'sidebar-left-' + gsapTarget" class="block absolute top-0 h-full" :src="leftImage" alt="Right image" style="left: -100%;">

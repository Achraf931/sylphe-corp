...
-->
    ...
    <!--    <section id="clients" class="bg-lightGray relative overflow-hidden mt-21 px-7.5 pt-20 pb-40 md:pt-10 md:pb-16">
          <div>
...
export default {
  ...
  mounted() {
    let toTop = this.$gsap.utils.toArray(".to-top");
    let toBottom = this.$gsap.utils.toArray(".to-bottom");
